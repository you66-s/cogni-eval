...
st.write("<ul><li>Logical and Analytical Reasoning</li><li>Algorithmic and Computational Thinking</li><li>Mathematical Reasoning</li><li>Memory and Attention</li><li>Code Comprehension and Debugging</li><li>Creativity and Problem-Solving</li></ul>", unsafe_allow_html=True)
